...
struct BlurY_PS
{
    ...
    PixelShader& Get(ShaderPermutations::ENABLE_SHARPNESS_PROFILE A, ShaderPermutations::KERNEL_RADIUS B)
    {
        return m_Shader[A][B];
    }

private:
    PixelShader m_Shader[ShaderPermutations::ENABLE_SHARPNESS_PROFILE_COUNT][ShaderPermutations::KERNEL_RADIUS_COUNT];
#if _WIN32
