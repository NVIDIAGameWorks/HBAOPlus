...
void HBAOSample::RenderUI()
{
    ...
    if (show_ssao_window)
    {
        ...
        {
            bool EnableDualLayerAO = mAOParameters.EnableDualLayerAO ? true : false;
            ImGui::Checkbox("DualLayerAO", &EnableDualLayerAO);
            mAOParameters.EnableDualLayerAO = EnableDualLayerAO;
        }
        ImGui::End();
    }
